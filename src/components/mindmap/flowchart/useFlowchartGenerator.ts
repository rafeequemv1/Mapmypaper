...
export const defaultFlowchart = `flowchart LR
    ...
    classDef decision fill:#D3E4FD,stroke:#3B82F6,stroke-width:3px,rx:15px,ry:15px
    classDef process fill:#F2FCE2,stroke:#22C55E,stroke-width:3px,rx:15px,ry:15px
    classDef subprocess fill:#FEF7CD,stroke:#F59E0B,stroke-width:3px,rx:15px,ry:15px
    classDef result fill:#FFDEE2,stroke:#EF4444,stroke-width:3px,rx:15px,ry:15px
    
    class A,K default
    class B decision
    class C,D process
    class E,F,G,H subprocess
    class I,J result`;
